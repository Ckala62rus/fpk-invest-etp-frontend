...
const routes = [
    ...
    },
    {
        ...
        meta: { layout: 'auth', guestOnly: true, title: 'Вход' },
    },
    {
        path: '/register',
        name: 'register',
        component: () => import('@/pages/auth/RegisterPage.vue'),
        meta: { layout: 'auth', guestOnly: true, title: 'Регистрация' },
    },
    {
        path: '/password/forgot',
        name: 'password.forgot',
        component: () => import('@/pages/auth/ForgotPasswordPage.vue'),
        meta: { layout: 'auth', guestOnly: true, title: 'Восстановление пароля' },
    },
    {
        path: '/password/reset',
        name: 'password.reset',
        component: () => import('@/pages/auth/ResetPasswordPage.vue'),
        meta: { layout: 'auth', title: 'Новый пароль' },
    },
    {
        path: '/password/admin-request',
        name: 'password.admin-request',
        component: () => import('@/pages/auth/AdminPasswordRequestPage.vue'),
        meta: { layout: 'auth', guestOnly: true, title: 'Обращение к администратору' },
    },
    {
        path: '/procedures',
    ...
    {
        path: '/admin/extra-conditions',
        name: 'admin.extraTemplates',
        component: () => import('@/pages/admin/AdminExtraConditionTemplatesPage.vue'),
        meta: {
            layout: 'admin',
            requiresAuth: true,
            roles: [ROLES.SUPER_ADMIN],
    ...
    {
        path: '/admin/procedures/:id/extra-conditions',
        name: 'admin.procedureExtraConditions',
        component: () => import('@/pages/admin/AdminProcedureExtraConditionsPage.vue'),
        meta: {
            layout: 'admin',
            requiresAuth: true,
            roles: [...ADMIN_ROLES],
            title: 'Условия процедуры',
        },
    },
    {
