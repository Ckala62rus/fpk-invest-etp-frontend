...
Пошаговая инструкция (гость → КП → аукцион, лоты, поля, приглашения, MailHog):

- в монорепо: `documentation/agent-notes/13-portal-user-guide.md`
- в backend-репозитории: `docs/portal-user-guide.md`
